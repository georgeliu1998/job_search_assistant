...
def generate_recommendation_from_results(
    ...
    NOTE: This function is now deprecated in favor of the recommendation
    generation built into JobEvaluationAgent. Kept for backward compatibility.
    ...
    """
    logger.warning(
        "Using deprecated generate_recommendation_from_results - recommendation now generated by JobEvaluationAgent"
    )
